...
print("\nLet's find a city in a given area. You must provide coordinates")
lat1 = input('Point 1 Latitude: ')
lon1 = input('Point 1 Longitude: ')
lat2 = input('Point 2 Latitude: ')
lon2 = input('Point 2 Longitude: ')
